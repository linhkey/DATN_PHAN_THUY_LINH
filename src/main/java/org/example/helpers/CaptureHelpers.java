...
public class CaptureHelpers extends ScreenRecorder{
    ...
    public static void captureScreenshot(WebDriver driver, String screenName) {
        try {
            ...
            File theDir = new File(projectPath + ".Screenshot");
            if (!theDir.exists()){
                theDir.mkdirs();
            }
            // Chổ này đặt tên thì truyền biến "screenName" gán cho tên File chụp màn hình
            FileHandler.copy(source, new File(projectPath + ".Screenshot" + "/" + screenName + "_" + dateFormat.format(new Date()) + ".png"));
    ...
    public static void startRecord(String methodName) throws Exception {
        ...
        File file = new File(projectPath + ".Video" + "/" + methodName + "_" + dateFormat.format(new Date()) + "/");
